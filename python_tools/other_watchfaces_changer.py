...
UseCase:
1. Make changes to 1 watchface
2. Use this script to change all other watchfaces

Note:
    Will automatically find all watchfaces of other colors and apply changes to them"""
